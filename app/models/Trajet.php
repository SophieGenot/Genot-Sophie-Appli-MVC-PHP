...
class Trajet extends AbstractModel {
    ...
    // findById(), findAll() et delete() sont héritées !

    public function findDisponibles(): array {
        // Cette requête reste ici car elle est complexe (JOIN)
    ...
    public function create(array $data): bool {
        ...
        ");
        return $stmt->execute([
            $data['agence_depart_id'], $data['agence_arrivee_id'], $data['gdh_depart'], 
            $data['gdh_arrivee'], $data['nb_places_total'], $data['nb_places_disponibles'], $data['auteur_id']
        ]);
    }
    ...
    public function update(int $id, array $data): bool {
        ...
        return $stmt->execute([
            $data['agence_depart_id'], $data['agence_arrivee_id'], $data['gdh_depart'], 
            $data['gdh_arrivee'], $data['nb_places_total'], $data['nb_places_disponibles'], $id
        ]);
    }
}