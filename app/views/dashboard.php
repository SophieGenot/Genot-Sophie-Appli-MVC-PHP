        ...
        <div class="trajet-list">
            <?php foreach($mes_trajets as $trajet): ?>
                <div class="trajet-card">
                    ...
                    <?php require __DIR__ . '/_trajet-modal.php'; ?>
                    
                    <a href="index.php?action=edit_trajet&id=<?= $trajet['id']; ?>" class="btn btn-primary">Modifier</a>
                    <a href="index.php?action=delete_trajet&id=<?= $trajet['id']; ?>" class="btn btn-danger" onclick="return confirm('Supprimer ce trajet ?')">Supprimer</a>
                </div>
            <?php endforeach; ?>
        </div>
    <?php else: ?>
